...
class mk_wp_nav_menu_walker extends Walker_Nav_menu {
    ...
    function start_el(&$output, $item, $depth = 0, $args = null, $id = 0) {
        ...
        if($item-> title == "Straipsniai") {
            $output .= "<li class='blog' class='" .  implode(" ", $item->classes) . "'> <a href=" . esc_url($item-> url) . ">" . $item-> title . "<span class='arrow-down'></a>";
            ...
            $output .= "<li class='store' class='" .  implode(" ", $item->classes) . "' > <a href=" . esc_url($item-> url) . ">" . $item-> title . "<span class='arrow-down'></span></a>";
