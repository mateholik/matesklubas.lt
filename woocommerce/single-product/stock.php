...
<p class="stock <?php echo esc_attr( $class ); ?>" <?php echo $block; ?>>
  ...
  <?php
	    ...
	    echo "Prekė išpirkta, greitu metu turėsime ją vėl! Rezervuok prekę iš anksto. Rašyk mums el. paštu <a href='mailto:info@matesklubas.lt'>info@matesklubas.lt</a> arba <a target='_blank' href='https://www.facebook.com/matesklubass'>facebook'e</a>.";
	}
    ?>
</p>
<p class="shippin">
