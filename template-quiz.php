            ...
            <transition name="animation">
                <div v-for="stepData in stepsData" :key="stepData.id" v-if="step === stepData.id" class="quiz__content">
                    ...
                    <div class="quiz__answers">
                        <div v-for="(answer, index) in stepData.answers" :key="index" v-on:click="nextStep(answer.value)" class="quiz__answer-wrap">
                    ...
                    <div class="quiz__answers">
                        <div class="quiz__answer-wrap quiz__answer-wrap--last">
                            <div class="quiz__answer quiz__answer--no-hover quiz__answer--loading">
                                <img data-gif="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/mate-loader.gif" data-webp="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/mate-loader.webp" ref="thinkingIcon">
                            </div>
                        </div>
                    </div>
                </div>
