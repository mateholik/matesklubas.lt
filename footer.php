        ...
        <div class="container">
            <div class="footer__menus">
                ...
                <div class="about">
                    ...
                    <a href="https://www.facebook.com/groups/1098983160306904/" target="_blank"
                        rel="noopener noreferrer">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icons/facebook.svg"
                            alt="fb-icon">
                        Facebook grupė
                    </a>
                    ...
                    <a href="https://www.youtube.com/channel/UCiL5qWJ7cer2tAvY7Y7sNwA" target="_blank"
                        rel="noopener noreferrer">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icons/youtube.svg"
                            alt="youtube-icon">
                        Youtube
                    </a>
                </div>
...
<div class="fb-customerchat" attribution=setup_tool page_id="696622920756854" theme_color="#FA9511"
    greeting_dialog_display="hide" logged_in_greeting="Sveiki, kuo galime padėti? :)"
